...
From today's date, determine the current quarter (Q1-Q4) and year. Find or note the corresponding brag file: `desempenho/conquistas/QN YYYY.md`.

### 2. Read Current Brag State

Read `desempenho/Conquistas.md` and the current quarter's brag note. Build a list of what's ALREADY captured.

### 3. Scan for Uncaptured Wins

Check these sources for achievements not yet in the brag doc:

**Work notes (trabalho/ativos/ and trabalho/arquivo/):**
...
**Brain notes:**
- `cerebro/Padrões.md` — new patterns discovered (shows expertise growth)
- `cerebro/Decisões-Chave.md` — decisions led (shows leadership)
