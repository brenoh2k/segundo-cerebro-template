...
- Person → `equipe/pessoas/<Name>.md`
- Project → `trabalho/ativos/<Name>.md` or `trabalho/arquivo/**/<Name>.md`
- Incident → `trabalho/incidentes/<Name>.md`
- Team → `equipe/times/<Name>.md`
- Concept → search `cerebro/`, `referencia/`
...
- `trabalho/` — project context, incident timelines
- `trabalho/individuais/` — meeting discussions about this topic
- `desempenho/` — brag entries, evidence, review briefs
- `cerebro/` — memories, patterns, decisions, gotchas
