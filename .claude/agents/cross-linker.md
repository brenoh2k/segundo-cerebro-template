...
- `equipe/pessoas/*.md` — every person name (including aliases from frontmatter)
- `equipe/times/*.md` — every team name
- `desempenho/competencias/*.md` — every competency name
- `trabalho/ativos/**/*.md`, `trabalho/arquivo/**/*.md` — every project name (recursive: grouped workstreams live in `active/<Topic>/` subfolders)
- `trabalho/incidentes/*.md` — every incident name
...
Write findings to `rascunhos/cross-link-audit-YYYY-MM-DD.md` with:
