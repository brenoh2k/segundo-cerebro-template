...
3. For each claim, search the vault:
   - `desempenho/evidencias/` for PR data
   - `desempenho/<cycle>/` for review briefs
   - `desempenho/conquistas/` for quarterly brag notes
   - `desempenho/competencias/` for competency criteria
   - `trabalho/` for project notes
   - `equipe/pessoas/` for person notes
   - `cerebro/` for operational context
