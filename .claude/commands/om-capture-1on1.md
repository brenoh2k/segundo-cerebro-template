...
2. **Create work note** at `trabalho/individuais/<Participant> <YYYY-MM-DD>.md` with:
...
4. **Update related notes**:
   ...
   - `trabalho/Index.md` (add to Review Prep or Active Projects as appropriate)
   - `cerebro/Memórias.md` if any context changed (manager dynamics, priorities, etc.)
   - `equipe/pessoas/` note for the participant
