...
3. **Create or update** the appropriate note following CLAUDE.md conventions:
   - Correct folder placement (trabalho/ativos/, trabalho/incidentes/, trabalho/individuais/, equipe/pessoas/, etc.)
...
4. **Update indexes** as needed (trabalho/Index.md, desempenho/Conquistas.md, equipe/Pessoas e Contexto.md)
