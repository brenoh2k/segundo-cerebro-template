...
- `cerebro/Norte.md` — how you write about yourself
- The most recent `trabalho/individuais/*.md` note — natural conversational voice
...
- **`trabalho/individuais/`** → conversational, direct, uses "I", okay to be informal
- **`desempenho/` review content** → corporate-confident but human, evidence-based, respect charcount
- **`trabalho/incidentes/`** → precise, factual, timeline-oriented, no filler
- **`cerebro/`** → terse shorthand, fragments okay
...
- If charcount matters (review content in `desempenho/`), verify limits after editing with `node --experimental-strip-types .claude/scripts/charcount.ts`.
