...
- Check if they have a person note in `equipe/pessoas/`
...
Create `trabalho/incidentes/<Incident Name>.md` with:
...
- Create in `equipe/pessoas/` with proper frontmatter (`date`, `title`, `description`, `team`, `tags: [person]`)
- Add to `equipe/Pessoas e Contexto.md`
...
- `trabalho/Index.md` — add to Incidents section
- `cerebro/Memórias.md` — add incident summary to Recent Context
- `cerebro/Padrões.md` — if this reveals a recurring pattern
- `cerebro/Armadilhas.md` — if this reveals a technical gotcha
- `desempenho/Conquistas.md` — add to relevant quarter with competency links
- `desempenho/conquistas/QN YYYY.md` — add detailed brag entry

### 7. Prepare Incident Report Draft (if applicable)

If you are or may lead the post-mortem:
- Check your org's post-mortem template (add it to `referencia/` if you have one)
- Create `trabalho/incidentes/TICKET-XXXX Post-Mortem Draft.md` following your org's post-mortem template
