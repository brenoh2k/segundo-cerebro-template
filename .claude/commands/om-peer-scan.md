...
Deep scan a peer's GitHub PRs for performance review preparation. Produces a structured analysis saved to `desempenho/evidencias/`.
...
4. **Save to vault** as `desempenho/evidencias/<Name> PRs - <Period>.md` with frontmatter:
   ```yaml
   ---
   date: "<today>"
