...
- `desempenho/<cycle>/Review Brief.md` (or current private brief) — full context
- `desempenho/Conquistas.md` — quarterly highlights
- `desempenho/conquistas/Q*.md` — quarterly detail notes for the period
- `desempenho/evidencias/Your PRs - *.md` — PR data
- `trabalho/*.md` — project notes for the period
- `desempenho/competencias/*.md` — competency definitions
...
- Markdown version in `desempenho/`
...
- Cross-check PR counts and dates against `referencia/` data
