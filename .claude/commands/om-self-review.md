...
Read in order:
1. `cerebro/Norte.md` — current goals and focus
2. `desempenho/<cycle>/Review Brief.md` — the full private review brief
3. `desempenho/<cycle>/Review Brief - Manager.md` — what the manager has seen
4. Previous cycle review — baselines
5. Quarterly brag notes covering the period
6. All competency notes in `desempenho/competencias/`
7. `desempenho/Performance Framework.md` — evaluation structure (if exists)
...
Save draft to `rascunhos/review-drafts.md` for copy-pasting.
After submission, promote to `desempenho/<cycle>/Self-Review.md`.
