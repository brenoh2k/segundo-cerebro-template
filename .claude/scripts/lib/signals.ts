...
export const SIGNALS: readonly Signal[] = [
	{
		name: "DECISION",
		message:
			"DECISION detected — consider creating a Decision Record in trabalho/ativos/ and logging in trabalho/Index.md Decisions Log",
		subHint: {
			message:
	...
	},
	{
		name: "INCIDENT",
		message:
			"INCIDENT detected — consider using /om-incident-capture or creating an incident note in trabalho/incidentes/",
		patterns: [
			// English
			"incident",
			"outage",
	...
	},
	{
		name: "1:1 CONTENT",
		message:
			"1:1 CONTENT detected — consider creating a 1-on-1 note in trabalho/individuais/ and updating the person note in equipe/pessoas/",
		patterns: [
			// English
			"1:1",
			"1-1",
	...
	},
	{
		name: "WIN",
		message:
			"WIN detected — consider adding to desempenho/Conquistas.md with a link to the evidence note",
		patterns: [
	...
	},
	{
		name: "ARCHITECTURE",
		message:
			"ARCHITECTURE discussion — consider creating a reference note in referencia/ or a decision record",
		patterns: [
			// English
			"architecture",
			"system design",
	...
	},
	{
		name: "PERSON CONTEXT",
		message:
			"PERSON CONTEXT detected — consider updating the relevant person note in equipe/pessoas/ and linking from the conversation note",
		patterns: [
			// English
			"told me",
			"said that",
	...
	},
	{
		name: "PROJECT UPDATE",
		message:
			"PROJECT UPDATE detected — consider updating the active work note in trabalho/ativos/ and checking if wins should go to brag doc",
		patterns: [
			// English
			"project update",
			"sprint",
