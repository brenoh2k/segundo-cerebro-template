 ...
 *  - source set: additionally excludes modelos/ (placeholder links by
 *    design) and rascunhos/session-logs/ (transcripts)
...
const SOURCE_SKIP_EXTRA = ["modelos", "rascunhos/session-logs"];
