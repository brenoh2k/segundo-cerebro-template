...
- **Batch by glob** — `mcp__qmd__multi_get` with `pattern` arg. CLI: `qmd --index <name> multi-get "equipe/pessoas/*.md" --json -l 40`.
...
- Loading context for review prep → `mcp__qmd__multi_get` with `pattern="desempenho/evidencias/*.md"`.
